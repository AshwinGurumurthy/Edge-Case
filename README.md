# Edge-Case — point it at a repo, get a test plan
...
much sharper with a Claude key.
...
cp .env.example context-agent/.env      # then set ANTHROPIC_API_KEY (and optionally TAVILY_API_KEY)
python context-agent/pipeline.py https://github.com/zeroclaw-labs/zeroclaw.git scenarios.md
```
